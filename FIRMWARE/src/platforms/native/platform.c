...
void platform_init(void)
{
	...
	gpio_set_mode(PMIC_SW_PORT, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, PMIC_SW_PIN);
	gpio_set(PMIC_SW_PORT, PMIC_SW_PIN);
	...
	gpio_set_mode(PORT_LED_PWR, GPIO_MODE_OUTPUT_2_MHZ,
			GPIO_CNF_OUTPUT_PUSHPULL,
			PIN_LED_PWR);
	
	gpio_set_mode(PORT_LED_COMMS, GPIO_MODE_OUTPUT_2_MHZ,
		GPIO_CNF_OUTPUT_PUSHPULL,
		PIN_LED_COMMS);
		
	gpio_set_mode(PORT_LED_USB, GPIO_MODE_OUTPUT_2_MHZ,
		GPIO_CNF_OUTPUT_PUSHPULL,
		PIN_LED_USB);
