...
#define LED_IDLE_RUN	LED_2
#define LED_ERROR	LED_2
#define LED_PWR		GPIO1
#define LED_COMMS	GPIO2
#define LED_USB		GPIO3
#define LED_PROG	GPIO1

#define PORT_LED_PWR	GPIOB
#define PIN_LED_PWR		GPIO4

#define PORT_LED_COMMS	GPIOA
#define PIN_LED_COMMS	GPIO6

#define PORT_LED_USB	GPIOA
...
#define UART_PIN_SETUP() do { \
	...
	gpio_set_mode(USBUSART_PORT, GPIO_MODE_INPUTGPIO_MODE_INPUT_2_MHZ, \
